  ...
  return (
    <div className="text-left text-sm text-black whitespace-pre-line">
      {message["Claim Node ID"] && (
        <div>
          <span className="font-semibold">Claim Node ID:</span>{" "}
          {message["Claim Node ID"]}
        </div>
      )}
      {message["Node Title"] && (
      ...
      {message["Claim Text"] && (
        <div>
          <span className="font-semibold">Claim:</span> {message["Claim Text"]}
        </div>
      )}
      {message["Evidence ID"] && (
        <div>
      ...
      {message["Unified Evidence Score"] !== undefined && (
        <div>
          <span className="font-semibold">Unified Evidence Score:</span>{" "}
          {message["Unified Evidence Score"]}
        </div>
      )}
      {message["Unified Evidence Score (%)"] && (
        <div>
      ...
      {message["Score"] !== undefined && (
        <div>
          <span className="font-semibold">Score:</span> {message["Score"]}
        </div>
      )}
      {message["Reasoning"] && (
        <div>
      ...
      {message["Final Credibility Score"] !== undefined && (
        <div>
          ...
          {message["Final Credibility Score"]}
        </div>
      )}
      ...
      {message["Category"] && (
        <div>
          <span className="font-semibold">Category:</span> {message["Category"]}
        </div>
      )}
      {message["Graph Pattern"] && (
        <div>
          <span className="font-semibold">Graph Pattern:</span>{" "}
          {message["Graph Pattern"]}
        </div>
      )}
      {message["Graph Implication"] && (
        <div>
          <span className="font-semibold">Graph Implication:</span>{" "}
          {message["Graph Implication"]}
        </div>
      )}
      {message["Severity"] && (
        <div>
          <span className="font-semibold">Severity:</span> {message["Severity"]}
        </div>
      )}
      {message["Matched Nodes"] && (
        <div>
          <span className="font-semibold">Matched Nodes:</span>{" "}
          {message["Matched Nodes"]}
        </div>
      )}
      {message["Node Claims"] && (
        <div>
          <span className="font-semibold">Node Claims:</span>{" "}
          {message["Node Claims"]}
        </div>
      )}
      {message["Matched Edges"] && (
        <div>
          <span className="font-semibold">Matched Edges:</span>{" "}
          {message["Matched Edges"]}
        </div>
      )}
      {message["Edge Details"] && (
        <div>
          <span className="font-semibold">Edge Details:</span>{" "}
          {message["Edge Details"]}
        </div>
      )}
      {message["Pattern Details"] && (
        <div>
          <span className="font-semibold">Pattern Details:</span>{" "}
          {message["Pattern Details"]}
        </div>
      )}
      ...
      {message["Affected Nodes"] && (
        <div>
          <span className="font-semibold">Affected Nodes:</span>{" "}
          {message["Affected Nodes"]}
        </div>
      )}
      {message["Affected Edges"] && (
        <div>
          <span className="font-semibold">Affected Edges:</span>{" "}
          {message["Affected Edges"]}
        </div>
      )}
