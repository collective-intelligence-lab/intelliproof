...
export default function SignInForm() {
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full max-w-md space-y-6 p-8 rounded-lg bg-white">
            <h2 className="text-2xl font-semibold text-black mb-2">Sign In</h2>
            <p className="text-black text-sm mb-6">Enter your credentials below</p>
            ...
            <p className="text-black mt-6 text-center">Don&apos;t have an account? <a href="/" className="text-black underline">Sign Up</a></p>
        </form>
    );
} 