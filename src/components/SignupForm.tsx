    ...
    return (
        <form onSubmit={handleSubmit} className="w-full max-w-md space-y-6 p-8 rounded-lg" style={{ fontFamily: 'Josefin Sans, sans-serif' }}>
            ...
            <div className="flex flex-col gap-4">
                <label className="text-black text-sm font-medium" htmlFor="firstName">First Name</label>
                <Input id="firstName" name="firstName" placeholder="e.g. John" value={form.firstName} onChange={handleChange} required />
            </div>
            <div className="flex flex-col gap-4">
                <label className="text-black text-sm font-medium" htmlFor="lastName">Last Name</label>
            ...
            <p className="text-black mt-6 text-center">Already have an account? <a href="/signin" className="text-black underline">Log in</a></p>
        </form>
    );
} 